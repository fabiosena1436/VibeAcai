...
const AddForm = styled.form`
  ...
  margin-bottom: 40px; display: flex; flex-direction: column; gap: 15px; border: 1px solid #eee;
`;
...
const StarIcon = styled.div`
  position: absolute; top: 10px; left: -8px; font-size: 1.8em;
  color: #facc15; transform: rotate(-15deg); pointer-events: none;
`;
    ...
    <>
      <div>
        ...
        <AddForm onSubmit={handleSubmitForm}>
          ...
          <FormGroup><label htmlFor="productDescription">Descrição:</label><textarea id="productDescription" value={productDescription} onChange={(e) => setProductDescription(e.target.value)} /></FormGroup>
          <FormGroup><label htmlFor="productPrice">Preço:</label><input type="number" id="productPrice" value={productPrice} onChange={(e) => setProductPrice(e.target.value)} step="0.01" min="0" required /></FormGroup>
          <FormGroup>
          ...
          <FormGroup><label htmlFor="productImageUrl">URL Imagem:</label><input type="text" id="productImageUrl" value={productImageUrl} onChange={(e) => setProductImageUrl(e.target.value)} /></FormGroup>
          <FormActions>
              ...
              <ProductListItem key={product.id}>
                ...
                <div className="product-image-container">
                  {product.imageUrl ? (
                    ...
                    <div style={{width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', backgroundColor: '#e0e0e0', fontSize: '0.8em', color: '#777'}}>Sem Imagem</div>
                  )}
                </div>
