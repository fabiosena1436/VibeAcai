...
const CheckoutPage = () => {
    ...
    const handleSubmitOrder = async (e) => {
        ...
        // --- [NOVO] VERIFICAÇÃO DO NÚMERO DE WHATSAPP ---
        // Aqui garantimos que o número de WhatsApp foi cadastrado nas configurações da loja.
        ...
        try {
            ...
            // --- [ALTERADO] LINK DINÂMICO DO WHATSAPP ---
            // Usamos settings.whatsapp que vem do contexto, ao invés de um número fixo.
            const whatsappLink = `https://wa.me/${settings.whatsapp}?text=${encodedWhatsappMessage}`;
